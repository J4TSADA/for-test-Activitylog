import type { ActivityLogRaw } from '@/app/(DashboardLayout)/types/activity-log';

export const mockActivityLogs: ActivityLogRaw[] = [
  {
  ...
  },
  {
    ...
    created_at: '2026-06-18 03:10:03.510976+00',
  },
  {
    ...
    user_id: null,
    metadata:
      '{"amount": "2714.00", "statusTo": "PAID", "statusFrom": "VERIFYING"}',
    description: 'invoice 87e4111f-2f29-476b-8aa2-a0c3aaab89b1 was updated',
    created_at: '2026-08-13 08:50:30.976022+00',
  },
];
